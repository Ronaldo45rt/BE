 ...
 * This file demonstrates how to integrate Bertembeddings with a web frontend
 */

// For React/Vue/Angular applications
export class BertembeddingsClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new BertembeddingsClient(provider, contractAddress);
